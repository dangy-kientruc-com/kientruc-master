				...
				<div class=" grid-container-3 grid-masonry-project js-index-grid-01 home-category-masonry" style="">
                    ...
                    <div class="item wow fadeIn">
                                <div class="kt-project-item">
                                    ...
                                    <?php  }?>
                                    <div class="item-image" style="background: url('https://www.kientruc.com/uploads/images/<?php echo $value['customer']['folder_upload']; ?>/images/<?php echo $value['avatar']['name']; ?>');background-size: <?php if($value['avatar']['compare']==1) echo '100%'; else echo 'cover'; ?> ; background-repeat: no-repeat;">
...
<div class="popup" style='position:fixed;top:0;left:0;width:100vw;height:100vh;background-color:#fff;z-index:10000;display: none;background-color:#e6f1f9'>
