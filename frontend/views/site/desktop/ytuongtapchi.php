			...
			<div class="user-left">
				...
				<div class="user-info">
					...
					<div class="user-contact">
						...
						<div class="user-contact-li user-contact-nc">
							<i class="fa fa-download"></i>Nâng cấp
						</div>
						<div class="clear"></div>
					</div>
			...
			<div class="user-right">
				...
				<div class="user-album clear">
					...
					<div class="user-album-bot">
						<div class="user-ytuong-li">
							<div class="user-ytuong-left">
								<img src="images/block2-1.png">
							</div>
							<div class="user-ytuong-right">
								<div class="user-ytuong-title">
									Cách trang trí phòng khách hợp phong thủy với người Việt
								</div>
								<div class="user-ytuong-cate">
									<i class="fa fa-folder"></i>Phong thủy nhà
								</div>
								<div class="user-ytuong-tt">
									Cũng giống như con người, mỗi căn nhà đều có tuổi thọ sử dụng riêng. Theo thời gian, những tác động xấu đến từ thiên nhiên và môi trường sẽ khiến căn nhà bị hư hỏng và xuống cấp.....
								</div>
							</div>
							<div class="clear"></div>
						</div>
