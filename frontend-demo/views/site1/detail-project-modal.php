 ...
 */
?>
    <div class="grid-container-2-fix" style="border: 1px solid #E0E0E0;">
        <div class="item-3">
            <div class="kt-detail-left">
                <h1>Căn hộ chung cư Estella Heights</h1>
                ...
                <div class="text-right like">
                    <div class="share">
                        ...
                        <div class="dropdown" style="float:right;margin-left: 15px">
                            <button class="btn btn-secondary dropdown-toggle arrowUp"
                                    style="border-radius: 100px;padding: 0;height: 35px;width: 35px;background-color: #EEF7F1;border-width: 0"
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example"
                            ...
                            <button type="button" class="btn btn-light" style="display: inline-flex;height: 35px"
                                    onclick="javascript:viewPhoto(1)">
                            ...
                            <button type="button" class="btn btn-light" style="display: inline-flex;height: 35px"
                                    onclick="javascript:viewPhoto(2)">
                                <i class="kt-icon grey size-14x14">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                        <g fill-rule="evenodd">
                                            <rect width="4" height="4" rx="2"/>
                    ...
                    for ($i = 1; $i < 10; $i++) {
                        ...
                        <div class="item<?= $i ?>" data-fancy-item="<?= $i ?>">
                            <div class="item-image"
                                ...
                                <div class="kt-flex-container absolute hover transition">
            ...
            <div class="grid-container-3-fix-2">
                <div class="item-2">
        ...
        <div class="item-0">
            <div class="kt-detail-right">
                <div class="transition absolute"
                     style="background-color: white;width: 100%;left: 0;top: 20px;padding: 0 20px;">
                ...
                <div style="min-height: 185px;"></div>
