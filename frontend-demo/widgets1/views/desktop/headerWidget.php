<div class="kt-head transition fixed">
    <nav class="clearfix kt-main-menu" id="elMenu">
        <div class="kt-pull-left el01">
            <div class="kt-logo">
                <a href="/site/index" title="KIENTRUC.com" class="a-white">
                    <img alt="KIENTRUC.com" title="KIENTRUC.com" src="/images/logo icon.jpg"
                         class="img-fluid img-logo">
                    <span class="span-name-website">KIENTRUC</span>
                    <span class="span-dot-com">.com</span>
                    <span class="span-slogan">Cùng bạn xây ước mơ</span>
                </a>
            </div>
            <div class="kt-fr-search">
        ...
        <div class="kt-pull-right el02">
            <ul class="list-unstyled">
                ...
                <li class="group-02 <?= $id == 1 ? '' : 'd-none' ?>">
                    <a href="/site/login" title="" class="clr">
                ...
                <li class="group-03 <?= $id == 2 ? '' : 'd-none' ?>">
                    ...
                    <a href="javascript:;" title="" class="clr">
                        <button type="button" class="btn" onclick="javascript:showNotify();"
                                style="background-image: url(/images/avatar.png);background-size: 100% auto;width: 40px;padding: 0">
                            <b>&nbsp;</b>
                        </button>
                    </a>
                </li>
                <li class="more" data-width="80" style="display: none">
                    ...
                    <ul class="list-unstyled dropdown-menu dropdown-menu-right" style="padding-right: 25px;"></ul>
                </li>
            </ul>
        </div>
    </nav>
...
<div class="box-notify transition visibility">
    <div class="fixed">
        <div class="full" onclick="javascript:offNotify();"></div>
        <div class="item1 transition">
            <div class="container-logo">
                <div class="kt-logo">
                    <a href="/site/index" title="KIENTRUC.com" class="a-white">
                        <img alt="KIENTRUC.com" title="KIENTRUC.com" src="/images/logo icon.jpg"
                             class="img-fluid img-logo">
                        <span class="span-name-website" style="color: white;font-weight: 500">KIENTRUC</span>
                        <span class="span-dot-com" style="color: white;font-weight: 400">.com</span>
                        <span class="span-slogan" style="color: #888888">Cùng bạn xây ước mơ</span>
                    </a>
                </div>
                <div class="clearfix"></div>
            </div>
...
<script type="text/javascript">
    ...
    async function offNotify() {
        ...
        $('body').find('.box-notify').addClass('visibility');
        return false;
    }
